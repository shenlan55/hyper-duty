...
import { pageCategory, getCategory, createCategory, updateCategory, deleteCategory } from '@/api/workflow/category'
...
const columns = [
  ...
  { prop: 'code', label: '分类编码', minWidth: 150 },
