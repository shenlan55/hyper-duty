    ...
    <el-card class="mt-4">
      ...
      >
        <template #actions="{ row }">
          ...
          <el-button size="small" type="danger" @click="handleCancelProcess(row)">作废</el-button>
        </template>
      </BaseTable>
    </el-card>
...
const columns = [
  ...
  { prop: 'processDefinitionId', label: '流程定义ID', minWidth: 220 },
  { prop: 'processDefinitionKey', label: '流程KEY', width: 180 },
  { prop: 'businessKey', label: '业务KEY', width: 150 },
