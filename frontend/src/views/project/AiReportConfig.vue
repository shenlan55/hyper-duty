      ...
      <div class="help-content">
        ...
        <el-collapse>
          <el-collapse-item title="日报默认模板">
            <pre>请基于上方的JSON项目数据，生成一份高质量的江苏移动SRE统维项目日报。
...
8. 使用层级结构：一、二、三 → 1.2.3. → (1)(2)(3)</pre>
          </el-collapse-item>
          <el-collapse-item title="周报默认模板">
            <pre>请基于上方的JSON项目数据，生成一份高质量的江苏移动SRE统维项目周报。
...
8. 使用层级结构：一、二、三 → 1.2.3. → (1)(2)(3)</pre>
          ...
          <el-collapse-item title="System Prompt默认值">
            <pre>你是一位专业的SRE项目管理专家，精通SRE（站点可靠性工程）的各项工作内容，包括运维保障、平台建设、故障治理、变更管理等。
你的职责是：
...
const defaultTemplates = {
  daily: `请基于上方的JSON项目数据，生成一份高质量的江苏移动SRE统维项目日报。
...
8. 使用层级结构：一、二、三 → 1.2.3. → (1)(2)(3)`,
  weekly: `请基于上方的JSON项目数据，生成一份高质量的江苏移动SRE统维项目周报。
...
const defaultSystemPrompt = `你是一位专业的SRE项目管理专家，精通SRE（站点可靠性工程）的各项工作内容，包括运维保障、平台建设、故障治理、变更管理等。
你的职责是：
1. 理解并分析提供的JSON格式SRE项目数据
2. 生成结构清晰、有推进感的项目周报
3. 重点突出本周的推进事项和里程碑达成
