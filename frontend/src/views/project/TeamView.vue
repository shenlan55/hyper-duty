  ...
  <div class="team-view">
    ...
    >
      ...
      <div class="task-description" style="margin-bottom: 20px;">
        ...
        <div class="description-content richtext-content" v-if="currentTaskForUpdate?.description" v-html="currentTaskForUpdate.description"></div>
...
import { getTaskPage, getTaskDetail, createProgressUpdate, getTaskProgressUpdates } from '@/api/task'
