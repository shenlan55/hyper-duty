...
# 前端配置
VITE_API_BASE_URL=http://192.168.3.143:8080/api

# 后端配置
CORS_ALLOWED_ORIGINS=http://192.168.3.143:5173
```
...
- **前端访问地址**: `http://192.168.3.143:5173`
- **后端API地址**: `http://192.168.3.143:8080/api`
...
- **frontend**: 前端应用容器 (Vue 3 + Element Plus)
  - 端口: 192.168.3.143:5173

- **backend**: 后端应用容器 (Spring Boot 3 + MyBatis)
  - 端口: 192.168.3.143:8080
