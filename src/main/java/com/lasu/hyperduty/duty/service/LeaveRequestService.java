...
public interface LeaveRequestService extends IService<LeaveRequest> {
     ...
     * @return 可用的顶岗人员列表
     */
    List<SysEmployee> getAvailableSubstitutes(Long scheduleId, String startDate, String endDate, Long leaveEmployeeId, Boolean excludeSameDayShifts, Long shiftId);
